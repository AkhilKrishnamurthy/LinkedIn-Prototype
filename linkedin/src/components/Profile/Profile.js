    ...
    render() {
        ...
        var modalpersonaldetails = (
            <div>
                <div>
                    <div>
                        <button type="button" class="profile-btn btn btn-primary" data-toggle="modal" data-target="#basicExampleModal">
                        ...
                        <div class="modal-dialog modal-lg modalStyle" role="document" width="750px"
                            ...
                            <div class="modal-content">
                                ...
                                <div className="form-group">
                                    ...
                                    <input label="fname" icon="fa-map-pin"
                                        group
...
<div className="form-group">
        ...
        const experiencevar = test1.map((experiencevalues, index) => {
            ...
            return (
                <div>
                    ...
                    <button type="button" class="profile-btn btn btn-primary" onClick={() => this.handledeleteexperiencemodal(index)}>delete</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <button type="button" class="profile-btn btn btn-primary" data-toggle="modal" data-target="#basicExampleModalExperience" onClick={() => this.handleeditexperiencemodal(index)}>edit</button>
                <hr/>
                </div>
            )
        ...
        var addeducationmodalvar = <button type="button" class="profile-btn btn btn-primary" data-toggle="modal" data-target="#basicExampleModalEducationADD" onClick={this.handleaddeducationmodal}>Add Education</button>
                        ...
                        <div class="modal fade modalStyle" id="basicExampleModalEducationADD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg modalStyle" role="document" width="750px"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                        <button type="button" class="btn btn-primary" data-dismiss="modal" onClick={this.handleaddtoeducationarray}>Add</button>
                                    </div>
                                </div>
                            </div>
                        </div></div>
        ...
        const educationvar = test2.map((educationvalues, index) => {
            ...
            return (
                <div>
                    ...
                    <button type="button" class="profile-btn btn btn-primary" value={it1} onClick={() => this.handledeleteeducationmodal(index)}>delete</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <button type="button" class="profile-btn btn btn-primary" value={it1} data-toggle="modal" data-target="#basicExampleModalEducation" onClick={() => this.handleediteducationmodal(index)}>edit</button>
               <hr/>
                </div>
            )
     ...
     edit Personal Details
                        ...
                        <div class="modal fade modalStyle" id="basicExampleModalEducation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg modalStyle" role="document" width="750px"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="profile-btn btn btn-secondary" data-dismiss="modal" onClick={this.cancelediteducationchanges}>Close</button>
                                        <button type="button" class="profile-btn btn btn-primary" onClick={this.saveediteducationchanges}>Save changes</button>
                                    </div>
                                </div>
                            </div>
                        </div></div>
        ...
        var modalskills = (
            <div><button type="button" class="profile-btn btn btn-primary" data-toggle="modal" data-target="#basicExampleModalskills">
                Add skills
        </button>
                    ...
                    <div class="modal-dialog modal-lg modalStyle" role="document" width="750px"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                               ...
                               <div className="mt-3">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <button type="button" class="btn btn-primary ml-3" onClick={this.saveskillschanges}>Save changes</button>
                               </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div>
                                    <div className="job-result-data p-3 mt-2 mb-2 row">
                                        ...
                                        <span className="col-lg-9">
                                            ...
                                            <div className="mt-3">
                                                <button type="button" class="profile-btn btn btn-primary" data-toggle="modal" 
                                                    data-target="#basicExampleModalExperienceADD" 
                                                    onClick={this.handleaddexperiencemodal}>Add Experience
                                                </button>
                                            </div>
                                        </span>
                                    </div>
