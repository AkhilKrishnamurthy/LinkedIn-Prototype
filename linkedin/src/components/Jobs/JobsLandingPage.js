                ...
                <JobHeader />
                        ...
                        <div className="row">
                            <div className = "jobs-landing-header-container">
                                ...
                                <div className="jobs-landing-search-container pull-center-1 col-lg-6 col-md-6 col-sm-6">
                                    <input type="text" className="form-control form-control-lg" placeholder="Search Jobs"></input>
                                </div>

                                <div className="jobs-landing-search-container pull-center-2 col-lg-6 col-md-6 col-sm-6">
                                    <input type="text" className="form-control form-control-lg" placeholder="Search Location"></input>
                                </div>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                            ...
                            <a class="nav-link" href="#">4 saved jobs <span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item">
                            <a class="nav-link" href="#">10 applied jobs</a>
                            </li>
                            <li class="nav-item">
                            <a class="nav-link disabled" href="#">Career interests</a>
                            </li>
                        </ul>
                     
                            <Link to = "/salary" >LinkedIn Salary</Link>
                            Looking for Talent?
                            <button class="btn linkedin-post-job my-2 my-sm-0" type="submit">Post a Job</button>
