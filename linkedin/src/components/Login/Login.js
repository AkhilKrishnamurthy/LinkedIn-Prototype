    ...
    renderField(field) {
        ...
        return (
          <div className={className}>
            ...
            <input className="form-control" type={fieldType} placeholder={filedPlaceHolder} {...field.input} />
                ...
                <form>
                    <div class="main-div">
                        ...
                        {error}
                            ...
                            <div class="form-group">
                            <Field label="" className="form-control" name="password" type = "password" component={this.renderField} placeholder="Password"/>
                                {/* <input type="password" class="form-control" name="password" placeholder="Password"/> */}
                            </div>
                            <button class="btn btn-primary" type="submit" onClick={handleSubmit(this.submitLogin.bind(this))}>Signin</button>
                            <br></br><br/>
